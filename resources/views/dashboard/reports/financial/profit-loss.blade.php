<x-app-layout>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Net Profit</div>
                                <div class="h3 mb-0 font-weight-bold text-gray-800">₹ 160,260</div>
                    ...
                    <table class="table table-bordered" id="profitLossTable">
                        ...
                        <tbody>
                            ...
                            <tr class="table-success">
                                ...
                                <td class="text-right"><strong>₹ 245,680</strong></td>
                                <td class="text-right"><strong>100.0%</strong></td>
                            </tr>
                            <tr>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;Product Sales</td>
                                <td class="text-right">₹ 215,680</td>
                            ...
                            <tr class="table-warning">
                                ...
                                <td class="text-right"><strong>₹ 98,272</strong></td>
                            ...
                            <tr class="table-info">
                                ...
                                <td class="text-right"><strong>₹ 147,408</strong></td>
                            ...
                            <tr class="table-warning">
                                ...
                                <td class="text-right"><strong>₹ 85,420</strong></td>
                            ...
                            <tr class="table-primary">
                                ...
                                <td class="text-right"><strong>₹ 61,988</strong></td>
    ...
    $(document).ready(function() {
        ...
        window.loadProfitLossReport = function() {
            ...
            console.log('Loading profit loss report:', { period, month, year });
