                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 mb-3" data-category="accessories">
                                    <div class="product-card" data-product='{"id":6,"name":"Leather Belt","sku":"BL-ACC-006","price":899,"stock":45,"image":"https://images.unsplash.com/photo-1553062407-98eeb64c6a62?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80"}'>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <strong class="text-primary">Rs899</strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <table class="table table-sm">
                                        <tr>
                                            <th>Subtotal:</th>
                                            <td class="text-right" id="subtotal">Rs0.00</td>
                                        </tr>
                                        <tr>
                                            <th>Discount:</th>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <th>Tax (18%):</th>
                                            <td class="text-right" id="taxAmount">Rs0.00</td>
                                        </tr>
                                        <tr class="table-success">
                                            <th>Total:</th>
                                            <td class="text-right"><strong id="grandTotal">Rs0.00</strong></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div id="customerDetails" style="display: none;">
                            <div class="border rounded p-3 mb-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span id="customerCredit" class="text-success">Rs50,000</span>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div id="paymentDetails">
                            ...
                            <div class="payment-detail" id="cashDetail">
                                ...
                                <div class="form-group">
                                    <label>Change</label>
                                    <input type="text" class="form-control" id="changeAmount" value="Rs0.00" readonly>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#amountReceived').on('input', function() {
                ...
                $('#changeAmount').val(change >= 0 ? 'Rs' + change.toFixed(2) : 'Rs0.00');
            });
                        ...
                        <div class="cart-item">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div class="text-right">
                                    <h6 class="mb-1 text-primary">Rs${item.price.toLocaleString('en-IN')}</h6>
                                    <strong>Rs${itemTotal.toLocaleString('en-IN')}</strong>
                                </div>
                            </div>
                        </div>
                    `;
            ...
            function updateTotals() {
                ...
                // Update display
                $('#subtotal').text('Rs' + subtotal.toLocaleString('en-IN', {
                ...
                $('#taxAmount').text('Rs' + tax.toLocaleString('en-IN', {
                    minimumFractionDigits: 2
                }));
                $('#grandTotal').text('Rs' + grandTotal.toLocaleString('en-IN', {
                    minimumFractionDigits: 2
                }));
